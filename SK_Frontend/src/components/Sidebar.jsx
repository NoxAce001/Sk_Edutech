...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { title: "Marquee Line", link: "/marqueeline" },
    {
      ...
      submenu: [
        { title: "Franchise List", icon: <PiStudentBold className="w-5 h-5" />, link: "/franchise_list" },
        ...
        { title: "Courses", icon: <RiBookShelfLine className="w-5 h-5" />, link: "/courses" },
        { title: "Certificates", icon: <PiUserListBold className="w-5 h-5" />, link: "/Certificates" },
      ],
    ...
    },
    {
      ...
      submenu: [
        { title: "Home Page", icon: <TbHomePlus className="w-5 h-5" />, link: "/exam" },
        { title: "Gallery", icon: <GrGallery className="w-5 h-5" />, link: "/question-bank" },
      ],
